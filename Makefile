...
tests: composer-validate test-php-7.2 test-php-7.3 test-php-7.4 test-php-8.0 test-php-8.1 test-php-8.2
.PHONY: tests
...
test-php-7.2: dcdown
	...
	$(DOCKER_COMPOSE_ISOLATED_RUN_COMMAND) phpstan analyze -c tests/phpstan-72.neon --memory-limit=-1 --level=8 src/
